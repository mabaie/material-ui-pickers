...
exports.TimePickerInline = function(props) {
  ...
  return React.createElement(
    ...
    __assign({ mergePreviousDateOnChange: true, autoOk: true }, props),
    function(_a) {
      var date = _a.date,
        utils = _a.utils,
      ...
      return React.createElement(
        ...
        React.createElement(TimePicker_1.default, {
          date: date,
...
exports.default = React.forwardRef(function(props, ref) {
  return React.createElement(exports.TimePickerInline, __assign({}, props, { forwardedRef: ref }));
});
