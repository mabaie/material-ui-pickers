...
declare const _default: React.ComponentType<
  | (Pick<ClockNumberProps, 'label' | 'index' | 'selected' | 'isInner'> &
      import('@material-ui/core').StyledComponentProps<'selected' | 'clockNumber'>)
  | (Pick<
      React.PropsWithChildren<ClockNumberProps>,
      'label' | 'children' | 'index' | 'selected' | 'isInner'
    > &
      import('@material-ui/core').StyledComponentProps<'selected' | 'clockNumber'>)
>;
