...
exports.DateTimePickerHeader = function(_a) {
  ...
  return React.createElement(
    ...
    {
      className: clsx_1.default(classes.toolbar, ((_b = {}), (_b[classes.toolBar24h] = !ampm), _b)),
    },
    React.createElement(
      'div',
      ...
      React.createElement(ToolbarButton_1.default, {
        variant: 'subtitle1',
        onClick: function() {
          return onOpenViewChange(DateTimePickerView_1.default.YEAR);
        },
      ...
      React.createElement(ToolbarButton_1.default, {
        variant: 'h4',
        onClick: function() {
          return onOpenViewChange(DateTimePickerView_1.default.DATE);
        },
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(ToolbarButton_1.default, {
          variant: 'h3',
          onClick: function() {
            return onOpenViewChange(DateTimePickerView_1.default.HOUR);
          },
        ...
        React.createElement(ToolbarButton_1.default, {
          variant: 'h3',
          onClick: function() {
            return onOpenViewChange(DateTimePickerView_1.default.MINUTES);
          },
...
exports.default = withStyles_1.default(exports.styles, { name: 'MuiPickerDTHeader' })(
  WithUtils_1.withUtils()(exports.DateTimePickerHeader)
);
