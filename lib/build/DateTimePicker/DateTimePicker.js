...
var DateTimePicker = /** @class */ (function(_super) {
  ...
  function DateTimePicker() {
    ...
    _this.handleChange = function(time, isFinish) {
      ...
      var withMeridiem = time_utils_1.convertToMeridiem(
        time,
  ...
  DateTimePicker.prototype.render = function() {
    ...
    return React.createElement(
      React.Fragment,
      null,
      React.createElement(DateTimePickerHeader_1.default, {
        date: date,
        openView: openView,
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          {
            selected:
              openView === DateTimePickerView_2.default.HOUR ||
  ...
  DateTimePicker.propTypes = {
    ...
    openTo: PropTypes.oneOf(
      Object.keys(DateTimePickerView_2.default).map(function(key) {
