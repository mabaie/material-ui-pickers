  ...
  DateTextField.prototype.render = function() {
    ...
    if (keyboard) {
      localInputProps[adornmentPosition + 'Adornment'] = React.createElement(
        ...
        __assign({ position: adornmentPosition }, InputAdornmentProps),
        React.createElement(
          IconButton_1.default,
          __assign({ disabled: disabled, onClick: this.openPicker }, KeyboardButtonProps),
          keyboardIcon
        )
      );
    }
    ...
    return React.createElement(
      ...
      __assign(
        ...
        other,
        { onError: undefined, onChange: this.handleChange, InputProps: inputProps }
      )
    );
  };
