...
var Input = /** @class */ (function(_super) {
  ...
  Input.prototype.render = function() {
    ...
    return this.props.mask
      ? React.createElement(
          react_text_mask_1.default,
          __assign({}, rest, { ref: this.createInputRef, keepCharPositions: keepCharPositions })
        )
      : React.createElement('input', __assign({}, rest, { ref: inputRef }));
  };
  Input.propTypes = {
    mask: PropTypes.any,
