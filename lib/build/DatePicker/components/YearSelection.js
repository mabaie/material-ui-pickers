    ...
    _this.scrollToCurrentYear = function(domNode) {
      ...
      if (currentYearElement && currentYearElement.scrollIntoView) {
        if (animateYearScrolling) {
          setTimeout(function() {
            return currentYearElement.scrollIntoView({ behavior: 'smooth' });
          }, 100);
        } else {
...
exports.default = withStyles_1.default(exports.styles, { name: 'MuiPickersYearSelection' })(
  WithUtils_1.withUtils()(YearSelection)
);
