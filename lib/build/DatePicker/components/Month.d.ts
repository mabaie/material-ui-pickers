...
declare const _default: React.ComponentType<
  Pick<
    Pick<MonthProps, 'children' | 'value' | 'classes' | 'onSelect'> &
      Partial<Pick<MonthProps, 'disabled' | 'selected'>> &
      Partial<
        Pick<
          {
            selected: boolean;
        ...
        >
      >,
    'children' | 'value' | 'onSelect' | 'disabled' | 'selected'
  > &
    import('@material-ui/core').StyledComponentProps<'root' | 'disabled' | 'selected'>
>;
