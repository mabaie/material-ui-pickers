...
declare const _default: React.ComponentType<
  Pick<
    React.PropsWithChildren<
      Pick<
        MonthSelectionProps,
        'onChange' | 'date' | 'classes' | 'maxDate' | 'minDate' | 'disablePast' | 'disableFuture'
      >
    >,
    'children' | 'onChange' | 'date' | 'maxDate' | 'minDate' | 'disablePast' | 'disableFuture'
  > &
    import('@material-ui/core/styles').StyledComponentProps<'container'>
>;
