...
exports.DatePickerInline = function(props) {
  ...
  return React.createElement(BasePicker_1.default, __assign({}, props, { autoOk: true }), function(
    _a
  ) {
    var date = _a.date,
      utils = _a.utils,
...
exports.default = React.forwardRef(function(props, ref) {
  return React.createElement(exports.DatePickerInline, __assign({}, props, { forwardedRef: ref }));
});
