(function(global, factory) {
  ...
  var date = PropTypes$1.oneOfType([
    PropTypes$1.object,
    PropTypes$1.string,
    PropTypes$1.number,
    ...
    (function(_super) {
      ...
      MuiPickersUtilsProvider.propTypes = {
        ...
        children: PropTypes$1.oneOfType([
          ...
          PropTypes$1.arrayOf(PropTypes$1.element.isRequired),
        ]).isRequired,
              ...
              update: function(r) {
                ...
                if (('undefined' == typeof r && (r = o.value), r !== t.previousConformedValue)) {
                  ...
                  var P = void 0,
                    x = void 0;
                  if (
                    (l instanceof Array && (P = (0, d.convertMaskToPlaceholder)(l, g)), l !== !1)
                  ) {
                    var w = a(r),
                      S = o.selectionEnd,
  ...
  var DateTextField =
    ...
    (function(_super) {
      ...
      DateTextField.propTypes = {
        ...
        TextFieldComponent: PropTypes$1.oneOfType([
          PropTypes$1.string,
          PropTypes$1.func,
          PropTypes$1.node,
        ]),
      ...
      __assign(
        {
          className: clsx(
            classes.toolbarBtn,
            className,
            ((_c = {}), (_c[classes.toolbarBtnSelected] = selected), _c)
          ),
        },
        other
      ),
  ...
  var Transition_1 = createCommonjsModule(function(module, exports) {
    ...
    Transition.propTypes = {
       ...
       * ```
       */
      children: PropTypes$1.oneOfType([PropTypes$1.func.isRequired, PropTypes$1.element.isRequired])
        .isRequired,
  ...
  var CalendarHeader$1 = withUtils()(
    withStyles(styles$4, {
      withTheme: true,
    ...
    (function(_super) {
      ...
      DatePicker.prototype.render = function() {
        ...
        return React.createElement(
          ...
          openView === 'month' &&
            React.createElement(MonthSelection$1, {
              date: this.date,
    ...
    (function(_super) {
      ...
      InlineWrapper.prototype.render = function() {
        ...
        var _b = this.props,
          ...
          clearLabel = _b.clearLabel,
          onClear = _b.onClear,
          showTodayButton = _b.showTodayButton,
          todayLabel = _b.todayLabel,
          onSetToday = _b.onSetToday,
          value = _b.value,
          format = _b.format,
          children = _b.children,
          onOpen = _b.onOpen,
            ...
            __assign(
              {
                ...
                classes: {
                  paper: clsx(
                    ...
                    ((_a = {}), (_a[classes.popoverPaperWider] = wider), _a)
                  ),
                },
                anchorOrigin: {
                  vertical: 'bottom',
  ...
  var styles$c = styles$j.createStyles({
    popoverPaper: {
      width: DIALOG_WIDTH,
      paddingBottom: 8,
    },
  ...
  var InlineWrapper$1 = withStyles(styles$c, {
    name: 'MuiPickersInline',
  })(InlineWrapper);
